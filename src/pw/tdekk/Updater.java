...
import pw.tdekk.deob.InverseVisitor;
import pw.tdekk.deob.OpaquePredicateVisitor;
...
public abstract class Updater extends Thread implements Runnable {
    ...
    public abstract String getCallbackRouter();
    ...
    public void run() {
        ...
        System.out.println("================================================");
        System.out.println("====================      ======================");
        System.out.println("=======       Swipe's 1337 Updater       =======");
        System.out.println("====================      ======================");
        System.out.println("================================================");
        System.out.println();
...
//                    multTime += (end - start);
        ...
        appendLine("Running on: OldSchool Runescape #"+revision);
        int totalGraphs = 0;
