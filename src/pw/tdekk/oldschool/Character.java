...
@VisitorInfo(hooks = {"overhead", "x", "y", "healthRepaintTick", "health", "maxHealth", "interactingIndex", "animation"})
public class Character extends GraphVisitor {
    ...
    @Override
    public void visit() {
        add("overhead", cn.getField(null, "Ljava/lang/String;"), "Ljava/lang/String;");
        visitAll(new PositionHooks());
        visitAll(new HealthRepaintTick());
    ...
    private class HealthRepaintTick extends BlockVisitor {
                            ...
                            if (cycle.referenced(init)) {
                                ...
                                if (an != null && an.opcode() == IMUL) {
                                    ...
                                    if (rn != null && rn.owner().equals("client") && rn.desc().equals("I")) {
                                        addHook(new FieldHook("healthRepaintTick", cycle.fin()));
                                        lock.set(true);
                                    }
                                }
                            }
